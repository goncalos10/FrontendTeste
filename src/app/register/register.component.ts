...
export class RegisterComponent implements OnInit, OnDestroy {
    ...
    // TODO: COMPONENTE INUTIL, UTILIZAR CÓDIGO PARA "CRIAR-EDITAR-UTILIZADOR"
    ...
    submitRegister() {
        ...
        /*const newUser = new any(this.registerForm.get('inputEmail').value, this.registerForm.get('inputCode').value,
